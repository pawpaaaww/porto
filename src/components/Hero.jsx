...
const Hero = () => {
  ...
  return (
    <section className={`relative w-full h-screen `}>
      <div
        className={`head1 absolute  mt-20   max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5`}>
        ...
        <div className='head2'>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hii there, We Are <p className='name text-[#915EFF]'>TriDev</p>
          </h1>
          <h3>
            <span
              ref={textRef}
              className={`${styles.heroSubText} mt-2 green-text-gradient`}></span>
          </h3>
