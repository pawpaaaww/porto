...
export const mobileProject = [
  ...
  },
  {
    ...
    image: upt,
    source_link: 'https://uptlogam.jogjakota.go.id',
    source_code_link: '',
  },
  {
    name: 'Attendify.id',
    description:
      'Project ini merupakan Sistem Informasi berbasis Web untuk kebutuhan manajemen karyawan. Fitur dalam aplikasi ini bertujuan untuk membuat manajemen karyawan menjadi lebih mudah dan efisien.',
    tags: [
      {
        name: 'Laravel',
        color: 'blue-text-gradient',
    ...
    image: attendify,
    source_link: 'https://attendify.id',
    source_code_link: '',
  },
  {
    name: 'Studio 360 ',
    description:
      'Project ini merupakan Company Profle yang berutujuan untuk memberikan informasi tentang perusahaan kepada client untuk meningkatkan enggagement perusahaan',
    tags: [
      {
        name: 'Next.js',
        color: 'blue-text-gradient',
    ...
    image: studio360,
    source_link: 'https://studio-360.vercel.app',
    source_code_link: '',
  },
  {
    name: 'Aleena Massage',
    description: 'Project ini merupakan Landing Page untuk memudahkan customer dalam proses reservasi.',
    tags: [
      {
        name: 'Laravel',
        color: 'blue-text-gradient',
    ...
    image: aleena,
    source_link: 'https://aleenamassage.com',
    source_code_link: '',
  },
];
...
export { list, profiles, technologies, experiences, educations, achievements, sertifikat };
